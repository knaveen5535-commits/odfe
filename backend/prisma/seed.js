...
async function main() {
    ...
    const demoAccounts = [
        { email: 'admin@odfe.local', pass: 'Admin@123', first: 'Admin', last: 'User', roleCode: 'admin', empCode: 'EMP-ADM', roleType: client_1.RoleType.ADMIN },
        { email: 'pos@odfe.local', pass: 'Pos@123', first: 'Employee', last: 'POS', roleCode: 'cashier', empCode: 'EMP-POS', roleType: client_1.RoleType.CASHIER },
        { email: 'kitchen@odfe.local', pass: 'Kitchen@123', first: 'Kitchen', last: 'Staff', roleCode: 'kitchen', empCode: 'EMP-KIT', roleType: client_1.RoleType.KITCHEN_STAFF },
    ];
        ...
        for (let i = 1; i <= 50; i++) {
            ...
            const order = await prisma.order.upsert({
                ...
                create: {
                    ...
                    status: isPaid ? client_1.OrderStatus.PAID : client_1.OrderStatus.DRAFT,
                    total: total,
                    itemCount: itemCount,
                    orderDate: orderDate,
                    orderLines: {
